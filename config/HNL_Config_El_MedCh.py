...
samples={
    ...
    'amc2016a':'/gv0/DATA/SKFlat/Run2UltraLegacy_v3/2016preVFP/MC_SkimTree_EGammaTnP/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8',
    ...
    'amc2016b':'/gv0/DATA/SKFlat/Run2UltraLegacy_v3/2016postVFP/MC_SkimTree_EGammaTnP/DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8',
...
bin_ID = [
    ...
    { 'var' : 'el_pt_cor' , 'type': 'float', 'bins': [15, 20, 25, 30, 35, 50, 70, 100, 200, 500], 'title':'p_{T} [GeV]' },
]
bin_Ele23 = [
    #{ 'var' : 'el_abs_sc_eta' , 'type': 'float', 'bins': [0., 0.8, 1.4442, 1.566, 2., 2.5], 'title':'|#eta_{SC}|' },
    { 'var' : 'el_sc_eta' , 'type': 'float', 'bins': [-2.5, -2., -1.566, -1.4442, -0.8, 0.0, 0.8,  1.4442, 1.566, 2., 2.5], 'title':'#eta_{SC}' },
    { 'var' : 'el_pt_cor'     , 'type': 'float', 'bins': [25,30, 40, 50, 100, 200, 500],         'title':'p_{T} [GeV]' },
]
bin_Ele12 = [
    #{ 'var' : 'el_abs_sc_eta' , 'type': 'float', 'bins': [0., 0.8, 1.4442, 1.566, 2., 2.5], 'title':'|#eta_{SC}|' },
    { 'var' : 'el_sc_eta' , 'type': 'float', 'bins': [-2.5, -2., -1.566, -1.4442, -0.8, 0.0, 0.8,  1.4442, 1.566, 2., 2.5], 'title':'#eta_{SC}' },
    { 'var' : 'el_pt_cor'     , 'type': 'float', 'bins': [15, 20, 30, 50,100,  200, 500],        'title':'p_{T} [GeV]' },
]
...
HNL_ULIDv2 = 'passingHNLMVAv2 ' +VetoGap
...
for key in Configs:
  ...
  Configs_2016b[key.replace("_2016a","_2016b")]=Configs[key].clone(data=samples["data2016b"],sim=samples["mg2016b"])
